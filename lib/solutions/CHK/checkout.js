...
module.exports = function (skus) {
    ...
    const numberOfBSepcialDealsFor3Bought = Math.floor((numberOfA - (numberOfASpecialDealsFor5Bought * 5)) / 3)
    const remainingAs = numberOfA - (numberOfASpecialDealsFor5Bought * 5) - (numberOfBSepcialDealsFor3Bought * 3)
    const priceOfAs = (numberOfASpecialDealsFor5Bought * 200) + (numberOfBSepcialDealsFor3Bought * 130) + (50 * remainingAs)
    ...
    const numberOfESpecialDeals = Math.floor(numberOfE / 2)
    const remainingEs = numberOfESpecialDeals % 2
